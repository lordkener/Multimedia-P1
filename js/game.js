	...
	data:[
	 {   // Primer nivel 
		...
		entities:[
			...
			{type:"villain", name:"person_2",x:520,y:205,calories:590},

			{type:"block", name:"wood", x:620,y:380,angle:90,width:100,height:25},
			{type:"block", name:"glass", x:620,y:280,angle:90,width:100,height:25},								
			{type:"villain", name:"person_1", x:620,y:205,calories:420},				

			{type:"hero", name:"covid_1",x:80,y:405},
			{type:"hero", name:"covid_2",x:140,y:405},
		]
	 },
		{   // Segundo nivel
			foreground:'desert-foreground',
			...
			entities:[
				...
				{type:"villain", name:"person_2",x:715,y:155,calories:590},
				{type:"villain", name:"person_1",x:670,y:405,calories:420},
				{type:"villain", name:"person_2",x:765,y:400,calories:150},

				{type:"hero", name:"covid_3",x:30,y:415},
				{type:"hero", name:"covid_4",x:80,y:405},
				{type:"hero", name:"covid_5",x:140,y:405},
			]
		}
	],
